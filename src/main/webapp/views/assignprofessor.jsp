    ...
    <div class="form-container">
        ...
        <div class="form-wrapper">
            <form action="${pageContext.request.contextPath}/SecretaryServlet" method="POST">
                ...
                <label for="professor_username">Username Καθηγητή:</label>
                <input type="text" id="professor_username" name="professor_username" required />

                <br><br>
                <button type="submit" class="btn">Ανάθεση Καθηγητή</button>
            </form>
