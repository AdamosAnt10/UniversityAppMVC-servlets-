    ...
    <div class="form-container">
        ...
        <div class="form-wrapper">
            <form action="${pageContext.request.contextPath}/ProfessorServlet" method="POST">
                ...
                <label for="reg_num">Αριθμός Μητρώου Φοιτητή:</label>
                <input type="number" id="reg_num" name="registration_number" required />


                <label for="grd">Βαθμός (0-10):</label>
                <input type="number" id="grd" name="grade" step="0.1" min="0" max="10" required />

                <br><br>
                <button type="submit" class="btn">Υποβολή Βαθμολογίας</button>
                <a href="${pageContext.request.contextPath}/views/dashboardprof.jsp">
                    <button type="button" class="btn btn-secondary">Επιστροφή στο dashboard</button>
                </a>
            </form>
        </div>
    </div>
